...
},{"./lib/grid":2,"./lib/ui":4,"jquery":5}],2:[function(require,module,exports){
'use strict';
...
var Grid = function () {
    ...
    _createClass(Grid, [{
        ...
        key: 'setSquare',
        value: function setSquare(x, y, square) {
        ...
        value: function getNeighbours(x, y) {
            ...
            [-1, 0, 1].forEach(function (xOffset) {
                [-1, 0, 1].forEach(function (yOffset) {
                    var xPos = x + xOffset,
                        yPos = y + yOffset;
                    ...
                    if (0 <= xPos && xPos < _this.width && 0 <= yPos && yPos < _this.height && (xOffset !== 0 || yOffset !== 0)) {

                        var square = _this.getSquare(xPos, yPos);
                        if (square !== null) {
                            neighbours.push({ x: xPos, y: yPos, square: square });
                        }
                    }
                });
            });
        ...
        key: 'getBombNeighbours',
        value: function getBombNeighbours(x, y) {
            return this.getNeighbours(x, y).filter(function (neighbour) {
        ...
        key: 'countBombNeighbours',
        value: function countBombNeighbours(x, y) {
        ...
        key: 'computeBombNeighbourCounts',
        value: function computeBombNeighbourCounts() {
            var counts = [];
        ...
        key: 'getBombNeighbourCount',
        value: function getBombNeighbourCount(x, y) {
            if (x < 0 || x >= this.width || y < 0 || y >= this.height) {
                throw new RangeError('Out of bounds of grid');
            }
        ...
        key: 'addRandomBombs',
        value: function addRandomBombs(nBombs) {
            for (var n = 0; n < nBombs; ++n) {
                var randomX = Math.round(Math.random() * (this.width - 1)),
        ...
        key: 'fillVisibleSquares',
        value: function fillVisibleSquares(x, y) {
            if (x < 0 || x >= this.width || y < 0 || y >= this.height) {
                return;
            }
        ...
        key: 'randomGrid',
        value: function randomGrid(width, height, nBombs) {
...
var Square = function Square(bomb, visible) {
...
var UI = function () {
    function UI(canvas, grid) {
        ...
        if (typeof grid === 'undefined') {
            grid = new Grid.randomGrid(16, 16, 40);
        }
    ...
    _createClass(UI, [{
        ...
        value: function transformScreenToGrid(x, y) {
            if (x < 0 || y < 0 || x >= this.canvas.width || y >= this.canvas.height) {
                throw RangeError('Out of bounds of canvas');
            }

            var gridX = Math.floor(x / this.canvas.width * this.grid.width);
            var gridY = Math.floor(y / this.canvas.height * this.grid.height);
        ...
        key: 'drawButton',
        value: function drawButton(ctx, gridX, gridY) {
            var screenPos = this.transformGridToScreen(gridX, gridY),
        ...
        key: 'drawBombCount',
        value: function drawBombCount(ctx, gridX, gridY) {
            var count = this.grid.getBombNeighbourCount(gridX, gridY);
            ...
            if (count > 0) {
                ...
                ctx.fillText(count, x + unitWidth / 2 - 5, y + unitHeight / 2 + 6);
            }
        }
        ...
        value: function onMouseUp(e) {
            var gridX = this.clickPosition.x,
                gridY = this.clickPosition.y;

            if (!this.grid.isBomb(gridX, gridY)) {
                this.grid.fillVisibleSquares(gridX, gridY);
            }
        ...
        value: function onMouseDown(e) {
            ...
            var gridPos = this.transformScreenToGrid(x, y),
                gridY = gridPos.y,
                gridX = gridPos.x;
...
},{"./grid":2,"./square":3,"underscore":6}],5:[function(require,module,exports){
/*!
